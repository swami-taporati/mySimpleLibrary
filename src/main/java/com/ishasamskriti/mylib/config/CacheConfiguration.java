package com.ishasamskriti.mylib.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ishasamskriti.mylib.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ishasamskriti.mylib.repository.UserRepository.USERS_BY_EMAIL_CACHE);
